...
void EWWidget::CreateProperties(Widget* pRoot)
{
	...
	Widget* pId = pRoot->AddNewChild<WEditBox>(WEditBox::Desc("editbox.png", 8, id), 0, "id");
	...
	Widget* pName = pRoot->AddNewChild<WEditBox>(WEditBox::Desc("editbox.png", 8, m_sName), 1, "name");
