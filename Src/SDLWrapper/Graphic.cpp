...
void GraphicEngine::DrawRect(sint16 x, sint16 y, sint16 width, sint16 height, uint8 r, uint8 g, uint8 b) const
{
	Draw_Rect(m_pScreen, x, y, width, height, SDL_MapRGB(m_pScreen->format, r, g, b));
}

void GraphicEngine::DrawFillRect(sint16 x, sint16 y, sint16 width, sint16 height, uint8 _r, uint8 _g, uint8 _b) const
{
...
const InputEvent& GraphicEngine::PollEvent()
{
	SDL_PollEvent(m_oInpuEvent.GetSDLEvent());

	m_oInpuEvent.GetMouseMove(m_iMouseX, m_iMouseY);

	return m_oInpuEvent;
}

const InputEvent& GraphicEngine::WaitEvent()
{
	SDL_WaitEvent(m_oInpuEvent.GetSDLEvent());
	return m_oInpuEvent;
}
...
void GraphicFrame::DrawRect(sint16 x, sint16 y, sint16 width, sint16 height, uint8 r, uint8 g, uint8 b) const
{
	ConvertFrameToGraphic(x, y);
	m_pGraphicEngine->DrawRect(x, y, width, height, r, g, b);
}

void GraphicFrame::DrawFillRect(sint16 x, sint16 y, sint16 width, sint16 height, uint8 r, uint8 g, uint8 b) const
{
	ConvertFrameToGraphic(x, y);
	m_pGraphicEngine->DrawFillRect(x, y, width, height, r, g, b);
}
