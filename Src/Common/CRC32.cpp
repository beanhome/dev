...
unsigned long CRC32::Reflect(unsigned long ulReflect, const char cChar) const
{
...
void CRC32::PartialCRC(unsigned long *ulCRC, const unsigned char *sData, unsigned long ulDataLength) const
{
    while(ulDataLength--)
    {
...
void CRC32::FullCRC(const unsigned char *sData, unsigned long ulDataLength, unsigned long *ulOutCRC) const
{
...
unsigned long CRC32::FullCRC(const unsigned char *sData, unsigned long ulDataLength) const
{
...
bool CRC32::FileCRC(const char *sFileName, unsigned long *ulOutCRC, unsigned long ulBufferSize) const
{
    *(unsigned long *)ulOutCRC = 0xffffffff; //Initilaize the CRC.
...
bool CRC32::FileCRC(const char *sFileName, unsigned long *ulOutCRC) const
{
