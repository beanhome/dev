...
static PGtypeHandler pg_handlers[] = {
	/* character types */
	{ 0,  "pg_catalog",  "char",            1,  CHAROID,         1002,  pqt_put_char,         pqt_get_char,        __HANDLER_DEFAULTS__},
	{ 1,  "pg_catalog",  "varchar",        -1,  VARCHAROID,      1015,  pqt_put_text,         pqt_get_text,        __HANDLER_DEFAULTS__}, /* supports ptr */
	{ 2,  "pg_catalog",  "bpchar",         -1,  BPCHAROID,       1014,  pqt_put_text,         pqt_get_text,        __HANDLER_DEFAULTS__}, /* supports ptr */
	{ 3,  "pg_catalog",  "text",           -1,  TEXTOID,         1009,  pqt_put_text,         pqt_get_text,        __HANDLER_DEFAULTS__}, /* supports ptr */

	/* boolean types */
	{ 4,  "pg_catalog",  "bool",            1,  BOOLOID,         1000,  pqt_put_bool,         pqt_get_bool,        __HANDLER_DEFAULTS__},

	/* numeric types */
	{ 5,  "pg_catalog",  "int2",            2,  INT2OID,         1005,  pqt_put_int2,         pqt_get_int2,        __HANDLER_DEFAULTS__},
	{ 6,  "pg_catalog",  "int4",            4,  INT4OID,         1007,  pqt_put_int4,         pqt_get_int4,        __HANDLER_DEFAULTS__},
	{ 7,  "pg_catalog",  "int8",            8,  INT8OID,         1016,  pqt_put_int8,         pqt_get_int8,        __HANDLER_DEFAULTS__},
	{ 8,  "pg_catalog",  "float4",          4,  FLOAT4OID,       1021,  pqt_put_float4,       pqt_get_float4,      __HANDLER_DEFAULTS__},
	{ 9,  "pg_catalog",  "float8",          8,  FLOAT8OID,       1022,  pqt_put_float8,       pqt_get_float8,      __HANDLER_DEFAULTS__},
	{10,  "pg_catalog",  "numeric",        -1,  NUMERICOID,      1231,  pqt_put_numeric,      pqt_get_numeric,     __HANDLER_DEFAULTS__},

	/* bytea types */
	{11,  "pg_catalog",  "bytea",          -1,  BYTEAOID,        1001,  pqt_put_bytea,        pqt_get_bytea,       __HANDLER_DEFAULTS__}, /* supports ptr */

	/* geometric types */
	{12,  "pg_catalog",  "point",          16,  POINTOID,        1017,  pqt_put_point,        pqt_get_point,       __HANDLER_DEFAULTS__},
	{13,  "pg_catalog",  "lseg",           32,  LSEGOID,         1018,  pqt_put_lseg,         pqt_get_lseg,        __HANDLER_DEFAULTS__},
	{14,  "pg_catalog",  "box",            32,  BOXOID,          1020,  pqt_put_box,          pqt_get_box,         __HANDLER_DEFAULTS__},
	{15,  "pg_catalog",  "circle",         24,  CIRCLEOID,        719,  pqt_put_circle,       pqt_get_circle,      __HANDLER_DEFAULTS__},
	{16,  "pg_catalog",  "path",           -1,  PATHOID,         1019,  pqt_put_path,         pqt_get_path,        __HANDLER_DEFAULTS__},
	{17,  "pg_catalog",  "polygon",        -1,  POLYGONOID,      1027,  pqt_put_polygon,      pqt_get_polygon,     __HANDLER_DEFAULTS__},

	/* monetary types */
	{18,  "pg_catalog",  "money",           8,  CASHOID,          791,  pqt_put_money,        pqt_get_money,       __HANDLER_DEFAULTS__},

	/* network address typess */
	{19,  "pg_catalog",  "inet",           -1,  INETOID,         1041,  pqt_put_inet,         pqt_get_inet,        __HANDLER_DEFAULTS__},
	{20,  "pg_catalog",  "cidr",           -1,  CIDROID,          651,  pqt_put_inet,         pqt_get_cidr,        __HANDLER_DEFAULTS__},
	{21,  "pg_catalog",  "macaddr",         6,  MACADDROID,      1040,  pqt_put_macaddr,      pqt_get_macaddr,     __HANDLER_DEFAULTS__},

	/* date & time types */
	{22,  "pg_catalog",  "time",            8,  TIMEOID,         1183,  pqt_put_time,         pqt_get_time,        __HANDLER_DEFAULTS__},
	{23,  "pg_catalog",  "timetz",         12,  TIMETZOID,       1270,  pqt_put_timetz,       pqt_get_timetz,      __HANDLER_DEFAULTS__},
	{24,  "pg_catalog",  "date",            4,  DATEOID,         1182,  pqt_put_date,         pqt_get_date,        __HANDLER_DEFAULTS__},
	{25,  "pg_catalog",  "timestamp",       8,  TIMESTAMPOID,    1115,  pqt_put_timestamp,    pqt_get_timestamp,   __HANDLER_DEFAULTS__},
	{26,  "pg_catalog",  "timestamptz",     8,  TIMESTAMPTZOID,  1185,  pqt_put_timestamptz,  pqt_get_timestamptz, __HANDLER_DEFAULTS__},
	{27,  "pg_catalog",  "interval",       16,  INTERVALOID,     1187,  pqt_put_interval,     pqt_get_interval,    __HANDLER_DEFAULTS__},

	/* object identifier types */
	{28,  "pg_catalog",  "oid",             4,  OIDOID,          1028,  pqt_put_int4,         pqt_get_int4,        __HANDLER_DEFAULTS__},

	/* UUID types */
	{29,  "pg_catalog",  "uuid",           16,  UUIDOID,         2951,  pqt_put_uuid,         pqt_get_uuid,        __HANDLER_DEFAULTS__},

	/* Record types (composites) */
	{30,  "pg_catalog",  "record",         -1,  RECORDOID,          0,  pqt_put_record,       pqt_get_record,      __HANDLER_DEFAULTS__},

	/* pqt types */
	{31,  "pqt",         "str",            -1,  InvalidOid,         0,  pqt_put_str,          NULL,                __HANDLER_DEFAULTS__}, /* supports ptr */
	{32,  "pqt",         "null",           -1,  InvalidOid,         0,  pqt_put_null,         NULL,                __HANDLER_DEFAULTS__},

	/* more character types */
	{33,  "pg_catalog",  "name",           -1,  NAMEOID,         1003,  pqt_put_text,         pqt_get_text,        __HANDLER_DEFAULTS__}  /* supports ptr */
};
		...
		if(which == PQT_COMPOSITE)
		{
			...
			for (nattrs=0; *attrs; nattrs++)
			{
				...
				for (name = attDescs[nattrs].attname; attrs < p; attrs += 2)
					*name++ = (char) (pqt_hex_to_dec(attrs[0]) << 4) | pqt_hex_to_dec(attrs[1]);
				*name = 0;
			}
...
"  SELECT n.n AS idx," \
"  (" \
"    SELECT n.nspname from pg_type nt JOIN pg_namespace n ON nt.typnamespace = n.oid" \
...
"     ARRAY" \
"     (" \
"       SELECT CASE WHEN tt.typtype = 'd' THEN tt.typbasetype ELSE a.atttypid END ||" \
"         ',' || attlen || ',' || atttypmod || ',' || encode(attname::bytea, 'hex')" \
"         FROM pg_type b" \
